...
# OIDC_ISSUER/OIDC_CLIENT_ID enable the "sign in through the identity
# provider" button; when either is empty the button is not rendered and the
# login screen keeps its previous behaviour.
