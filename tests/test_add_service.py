...
@patch("api.services.service_services.add_service.catalog_settings")
class TestAddService:
    """Test cases for add_service function."""

    def test_add_service_minimal_parameters(self, mock_catalog_settings):
        """Test add_service with minimal required parameters."""
        # Setup mocks
        mock_ckan = MagicMock()
        mock_ckan.package_create.return_value = {"id": "service-123"}
        mock_ckan.resource_create.return_value = None
        ...
        mock_ckan.package_create.assert_called_once()
        mock_ckan.resource_create.assert_called_once()

    def test_add_service_all_parameters(self, mock_catalog_settings):
        """Test add_service with all parameters provided."""
        # Setup mocks
        mock_ckan = MagicMock()
        mock_ckan.package_create.return_value = {"id": "service-456"}
        mock_ckan.resource_create.return_value = None
        mock_catalog_settings.local_catalog = mock_ckan
        ...
        package_call = mock_ckan.package_create.call_args
        ...
        resource_call = mock_ckan.resource_create.call_args
    ...
    def test_add_service_custom_ckan_instance(self, mock_catalog_settings):
        ...
        mock_catalog_settings.ckan.action.package_create.assert_not_called()

    def test_add_service_invalid_owner_org(self, mock_catalog_settings):
    ...
    def test_add_service_invalid_extras_type(self, mock_catalog_settings):
    ...
    def test_add_service_extras_with_reserved_keys(self, mock_catalog_settings):
    ...
    def test_add_service_package_create_error(self, mock_catalog_settings):
    ...
    def test_add_service_resource_create_error(self, mock_catalog_settings):
    ...
    def test_add_service_no_package_id_returned(self, mock_catalog_settings):
        """Test add_service when package creation returns no ID."""
        # Setup mock to return empty dict
        mock_ckan = MagicMock()
        mock_ckan.package_create.return_value = {}  # No ID returned
        mock_catalog_settings.local_catalog = mock_ckan
    ...
    def test_add_service_default_notes(self, mock_catalog_settings):
        """Test add_service with default notes when none provided."""
        # Setup mocks
        mock_ckan = MagicMock()
        mock_ckan.package_create.return_value = {"id": "default-notes"}
        mock_ckan.resource_create.return_value = None
        mock_catalog_settings.local_catalog = mock_ckan
    ...
    def test_add_service_explicit_notes(self, mock_catalog_settings):
        """Test add_service with explicit notes provided."""
        # Setup mocks
        mock_ckan = MagicMock()
        mock_ckan.package_create.return_value = {"id": "explicit-notes"}
        mock_ckan.resource_create.return_value = None
        mock_catalog_settings.local_catalog = mock_ckan
    ...
    def test_add_service_optional_service_fields(self, mock_catalog_settings):
        """Test add_service with only some optional service fields."""
        # Setup mocks
        mock_ckan = MagicMock()
        mock_ckan.package_create.return_value = {"id": "optional-fields"}
        mock_ckan.resource_create.return_value = None
        mock_catalog_settings.local_catalog = mock_ckan
    ...
    def test_add_service_no_extras_at_all(self, mock_catalog_settings):
        """Test add_service with no extras or optional fields."""
        # Setup mocks
        mock_ckan = MagicMock()
        mock_ckan.package_create.return_value = {"id": "no-extras"}
        mock_ckan.resource_create.return_value = None
        mock_catalog_settings.local_catalog = mock_ckan
    ...
    def test_add_service_preserve_user_extras(self, mock_catalog_settings):
        """Test that user extras are preserved when adding service extras."""
        # Setup mocks
        mock_ckan = MagicMock()
        mock_ckan.package_create.return_value = {"id": "preserve-extras"}
        mock_ckan.resource_create.return_value = None
        mock_catalog_settings.local_catalog = mock_ckan
