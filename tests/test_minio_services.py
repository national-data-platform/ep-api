...
class MockS3Error(S3Error):
    def __init__(self, message, code):
        ...
        super().__init__(
            code, message, "resource", "request_id", "host_id", mock_response
        )
...
class TestBucketService:
    ...
    async def test_create_bucket_success(self):
        ...
        with patch(
            "api.services.minio_services.bucket_service.minio_client"
        ) as mock_client:
            ...
            mock_client.client.make_bucket.assert_called_once_with(
                "test-bucket", location=None
            )
    ...
    async def test_delete_bucket_not_empty(self):
        ...
        with patch(
            ...
            mock_client.client.bucket_exists.return_value = True
            mock_client.client.list_objects.return_value = [
                mock_object
            ]  # Non-empty bucket
...
class TestObjectService:
    ...
    async def test_upload_object_success(self):
        ...
        with patch(
            "api.services.minio_services.object_service.minio_client"
        ) as mock_client:
            mock_client.client.bucket_exists.return_value = True
    ...
    async def test_delete_object_success(self):
        ...
        with patch(
            ...
            assert result is True
            mock_client.client.remove_object.assert_called_once_with(
    ...
    async def test_delete_object_not_found(self):
        ...
        with patch(
            ...
            mock_client.client.stat_object.side_effect = create_s3_error_mock(
                "No such key", "NoSuchKey"
            )
    ...
    async def test_generate_presigned_upload_url_success(self):
        ...
        with patch(
            ...
            mock_client.client.bucket_exists.return_value = True
            mock_client.client.presigned_put_object.return_value = (
                "https://presigned-url"
            )
    ...
    async def test_generate_presigned_download_url_success(self):
        ...
        with patch(
            ...
            mock_client.client.stat_object.return_value = mock_stat
            mock_client.client.presigned_get_object.return_value = (
