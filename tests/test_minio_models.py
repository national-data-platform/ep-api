...
from api.models.minio_models import (
    BucketCreateRequest, BucketInfo, BucketListResponse,
    ObjectInfo, ObjectListResponse, ObjectUploadRequest, ObjectUploadResponse,
    PresignedUrlRequest, PresignedUrlResponse, ObjectMetadataResponse, ErrorResponse
)
...
class TestErrorModel:
    ...
    def test_error_response_with_detail(self):
        ...
        error = ErrorResponse(
            ...
            detail="The bucket name is invalid"
        )
